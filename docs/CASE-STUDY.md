...
This page + the demo are enough for a short interview skim. For a deep check in the repo, start at the root [`README.md`](../../README.md) (theme list + instruments). Theme notes live under `docs/wiki/working/`.
